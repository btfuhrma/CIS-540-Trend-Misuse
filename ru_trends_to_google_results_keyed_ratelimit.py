...
def main():
    ...
    csv_in = f"RU_Trends/RU_{stamp}.csv"
    snapshot_json = Path(f"./JSON_Search_Results/ru_google_results_{stamp}.json")
    snapshot_csv  = Path(f"./CSV_Search_Results/ru_google_results_{stamp}.csv")  
    master_json   = here / "ru_google_results_master.json"
    master_csv    = here / "ru_google_results_master.csv"
