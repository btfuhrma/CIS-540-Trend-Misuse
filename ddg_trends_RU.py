...
def main():
    ...
    csv_files = [f"RU_Trends/RU_{today}.csv"]
    ...
    if new_data:
        new_json = os.path.join("JSON_Search_Results", f"ru_ddg_results_{today}.json")
        new_csv = os.path.join("CSV_Search_Results", f"ru_ddg_results_{today}.csv")
